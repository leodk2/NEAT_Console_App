...
namespace NEAT_Console_App
{
    class Genome
    {
        List<ConnectionGene> genes = new List<ConnectionGene>();//a list of connections between nodes which represent the NN
        ...
        int getInnovationNumber(List<connectionHistory> innovationHistory, Node from, Node to)
        {
            ...
            {//if the mutation is new then create an arrayList of integers representing the current state of the genome
                List<Integer> innoNumbers = new List<Integer>();
                for (int i = 0; i < genes.size(); i++)
        ...
        void drawGenome(int startX, int startY, int w, int h)
        {
            ...
            List<PVector> nodePoses = new List<PVector>();
            List<Integer> nodeNumbers = new List<Integer>();
